...
module.exports = function setup(
  predicate,
  {
    // @todo Only set when the auth fail or when it errors out or both?
    errorJSON = { ok: false },

    // @todo This cannot be async and it cannot throw!!
    // @todo How to enforce this behaviour at compile time?
  ...
  return async function auth(req, res, next) {
    try {
      // If predicate returns true with the request object,
